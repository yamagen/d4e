\newcommand{\timestamp}{Last change: 2025/04/13-15:35:22.}
\if0
...
\newcommand*{\mySound}[1]{\href{https://cuckoo.js.ila.titech.ac.jp/~yamagen/d4ev5/d4e/snd/d4e#1.mp3}{\textcolor{white}{■}\hspace{-1zw}\includegraphics[bb=0 0 32 32,clip,width=3mm]{./img/speakerM32-3.png}}}
%       \href{https://cuckoo.js.ila.titech.ac.jp/~yamagen/dictee/snd/day00101.mp3}
%       {\textcolor{white}{■}\hspace{-1zw}\includegraphics[bb=0 0 32 32,clip,width=3mm]{./img/speakerM32-3.png}}
...
\ifEnglish
  ...
  \date{Institute of Science Tokyo }
\else
  \title{D4E: Dictation for Every Day\\
    \vspace{-.5\baselineskip}
  \Colorrule{red}\\\normalsize 毎日のディクテーション}
...
\ifVOLFOUR % すべての表紙を見せる時
    \put(50,308){\fbox{\includegraphics[trim=0 0 0 0,clip,width=.75\hsize]{./img/nipper.eps}}}
    \put( 50,183){\fbox{\includegraphics[trim=0 0 0 0,clip,height=.3\hsize]{./img/410px-Meisje_met_de_parel.jpg}}}
    \put(157,183){\fbox{\includegraphics[trim=0 0 0 .4,clip,height=.3\hsize]{./img/MlleIreneCahen.jpg}}}
    ...
    \put(257,183){\fbox{\includegraphics[trim=60 80 60 30,clip,height=.3\hsize]{./img/MaryLemon.eps}}}
\else
    \put(15,184){\includegraphics[trim=0 0 0 0,clip,width=1.35\hsize]{./img/nipper.eps}}%VOLONE
...
\fi%VOLFOUR
      ...
      \put( 270,145){\itshape\bfseries Ph.\,D.\,in Linguistics}
      \put( 50, 80){\fbox{\includegraphics[width=35mm]{./img/sciencetokyo.png}}}
      \put(170,80){\includegraphics[trim=0 0 0 0,clip,width=.14\hsize]{./img/titech12isct.png}}
      \put(225,80){\includegraphics[trim=0 0 0 0,clip,width=.14\hsize]{./img/d4eisct.png}}
      \put(280,80){\includegraphics[trim=0 0 0 0,clip,width=.14\hsize]{./img/beyondwords.png}}
    \else
      \put(150,616){\scalefont{2.5}\bfseries D4E: Dictation for Every Day}
  ...
  \begin{picture}(0,130)(60,100)
    \put(63,60){\includegraphics[width=.5\hsize]{./img/nipper.eps}}
    \put(60,57){\framebox(191,110){}}
    \put(255,57){\includegraphics[width=5mm]{./img/Cc-public_domain_mark_white.eps}}
    \ifEnglish
  ...
  \begin{tabular}[t]{rl}
    \begin{minipage}[c]{24mm}
      \fbox{\includegraphics[trim=0 170 490 180,clip,width=20mm]{./img/cclicense.eps}}
    \end{minipage}
&
...
\begin{figure}[htb]\centering\small
  \fbox{\includegraphics[trim=0 0 0 0,clip,width=.8\hsize]{./img/d4e-screen07.pdf}}
...
\begin{figure}[ht]\centering
  \fbox{\includegraphics[trim=100 60 100 70, clip, width=.3\hsize]{./img/fukuwarai02.pdf}}
...
\begin{enumerate}
  \ifWB
  \item レストラン？\underline{\hspace{6em}}、どこでもいいよ。\mySound{04701}\\A Restaurant? Anywhere is fine if it's convenient.%てきとうなところ
  \else
  \item レストラン？\underline{\ruby{適当}{てきとう}なところ}、どこでもいいよ。\mySound{04701}\\A Restaurant? Any place is fine with me.%てきとうなところ
  \fi%WB
%D4E%ID:1
%D4E%sentence:(レストラン:れすとらん)？<BLANK>、どこでもいいよ。
%D4E%english:A restaurant? Any place is fine with me.
%D4E%answer:てきとうなところ
%D4E%model:適当なところ
%D4E%roman:tekitou
%D4E%notes:resutorann (restaurant); dokodemo (wherever).
  \ifWB
  \item \ruby{私}{わたし}は\underline{\hspace{6em}}。\mySound{04702}\\My stomach hurts a little.%いがちょっと
  \else
  \item \ruby{私}{わたし}\underline{\ruby{胃}{い}がちょっと}。\mySound{04702}\\My stomach hurts a little.%いがちょっと
  \fi%WB
%D4E%ID:2
%D4E%sentence:(私:わたし)は<BLANK>。
%D4E%english:My stomach hurts a little.
%D4E%answer:いがちょっと
%D4E%model:胃がちょっと
%D4E%roman:igachotto
%D4E%notes:watashi (I).
  \ifWB
  \item いつから\underline{\hspace{6em}}か。\mySound{04703}\\When did it start to hurt?%いたむんです
  \else
  \item いつから\underline{\ruby{痛}{いた}むんです}か。\mySound{04703}\\When did it start to hurt?%いたむんです
  \fi%WB
%D4E%ID:3
%D4E%sentence:いつから<BLANK>か。
%D4E%english:When did it start to hurt?
%D4E%answer:いたむんです
%D4E%model:痛むんです
%D4E%roman:itamunndesu
%D4E%notes:itsukara (since when)
  \ifWB
  \item \underline{\hspace{6em}}。\mySound{04704}\\Around noon, probably.%おひるごろから
  \else
  \item \underline{お\ruby{昼}{ひる}ごろから}。\mySound{04704}\\Around noon, probably.%おひるごろから
  \fi%WB
%D4E%ID:4
%D4E%sentence:<BLANK>。
...
%D4E%notes:goro (around); hiru (noon).
  \ifWB
  \item \ruby{少}{すこ}し\underline{\hspace{6em}}？\mySound{04705}\\Are you feeling better?%らくになった
  \else
  \item \ruby{少}{すこ}し\underline{\ruby{楽}{らく}になった}？\mySound{04705}\\Are you feeling better?%らくになった
  \fi%WB
%D4E%ID:5
%D4E%sentence:(少:すこ)し<BLANK>？
%D4E%english:Are you feeling better?
%D4E%answer:らくになった
%D4E%model:楽になった
...
%D4E%notes:sukoshi (a little).
  ...
  \ifWB
  \item \underline{\hspace{6em}}。\mySound{04706}\\I'll eat something.%なにかたべます
  \else
  \item \underline{\ruby{何}{なに}か\ruby{食}{た}べます}。\mySound{04706}\\I'll eat something.%なにかたべます
  \fi%WB
%D4E%ID:6
%D4E%sentence:<BLANK>。
%D4E%english:I'll eat something.
%D4E%answer:なにかたべます
%D4E%model:何か食べます
%D4E%roman:nanikatabemasu
%D4E%notes:nanika (anything)
  \ifWB
  \item じゃ、\underline{\hspace{6em}}\ruby{食}{た}べる？\mySound{04707}\\If it's something gentle on my stomach, I can eat.
  \else
  \item じゃ、\underline{やさしいものなら}\ruby{食}{た}べる？\mySound{04707}\\If it's something gentle on my stomach, I can eat.
  \fi%WB
%D4E%ID:7
%D4E%sentence:じゃ、<BLANK>(食:た)べる？
%D4E%english:If it's something gentle on my stomach, I can eat.
%D4E%answer:やさしいものなら
%D4E%model:やさしいものなら
%D4E%roman:yasashiimononara
%D4E%notes:taberu (eat).
  \ifWB
  \item \ruby{今日}{きょう}は\ruby{暑}{あつ}かったから、\underline{\hspace{6em}}、\ruby{食}{た}べたい。\mySound{04708}\\Since it was hot today, I feel like eating something light.
  \else
  \item \ruby{今日}{きょう}は\ruby{暑}{あつ}かったから、\underline{さっぱりとしたもの}、\ruby{食}{た}べたい。\mySound{04708}\\Since it was hot today, I feel like eating something light.
  \fi%WB
%D4E%ID:8
%D4E%sentence:(今日:きょう)は(暑:あつ)かったから、<BLANK>、(食:た)べたい。
%D4E%english:Since it was hot today, I feel like eating something light.
%D4E%answer:さっぱりとしたもの
%D4E%model:さっぱりとしたもの
%D4E%roman:sapparitoshitamono
%D4E%notes:kyou (today); atsukatta (it was hot); tabetai (want to eat).
  \ifWB
  \item そうめんとか、\ruby{冷}{ひ}やしうどんとか、なら\underline{\hspace{6em}}けど。\mySound{04709}\\I could make somen or chilled udon, if you like.
  \else
  \item そうめんとか、\ruby{冷}{ひ}やしうどんとか、なら\underline{\ruby{用意}{ようい}できる}けど。\mySound{04709}\\I could make somen or chilled udon, if you like.
  \fi%WB
%D4E%ID:9
%D4E%sentence:そうめんとか、(冷:ひ)やしうどんとか、なら<BLANK>けど。
%D4E%english:I could make somen or chilled udon, if you like.
%D4E%answer:よういできる
%D4E%model:用意できる
%D4E%roman:youidekiru
%D4E%notes:soumenn (somen noodle); hiyashiudon (cold udon noodle).
  \ifWB
  \item じゃ、\underline{\hspace{6em}}。\mySound{04710}\\OK, I'll leave it to you.
  \else
  \item じゃ、\underline{おまかせします}。\mySound{04710}\\OK, I'll leave it to you.
  \fi%WB
%D4E%ID:10
%D4E%sentence:じゃ、<BLANK>。
%D4E%english:OK, I'll leave it to you.
%D4E%answer:おまかせします
%D4E%model:おまかせします
...
%D4E%notes:itsumo (always); yasumi (day off).
  \ifWB
  \item \ruby{毎日}{まいにち}、\ruby{仕事}{しごと}で\ruby{忙}{いそが}しいんで、\underline{\hspace{6em}}\ruby{寝}{ね}てます。\mySound{04802}\\I'm busy with work every day, so I usually sleep until after noon.
  \else
  \item \ruby{毎日}{まいにち}、\ruby{仕事}{しごと}で\ruby{忙}{いそが}しいんで、\underline{\ruby{昼過}{ひるす}ぎまで}\ruby{寝}{ね}てます。\mySound{04802}\\I'm busy with work every day, so I usually sleep until after noon.
  \fi%WB
%D4E%ID:2
%D4E%sentence:(毎日:まいにち)、(仕事:しごと)で(忙:いそ)がしいんで、<BLANK>(寝:ね)てます。
%D4E%english:I'm busy with work every day, so I usually sleep until after noon.
%D4E%answer:ひるすぎまで
%D4E%model:昼過ぎまで
%D4E%roman:hirusugimade
%D4E%notes:maichi (every day); shigoto (work); isogashii (busy); nemasu (sleep).
  \ifWB
  \item じゃ、\underline{\hspace{6em}}はたいへんね。\mySound{04803}\\So weekdays are really tough for you.
  \else
  \item じゃ、\underline{\ruby{平日}{へいじつ}}はたいへんね。\mySound{04803}\\So weekdays are really tough for you.
  \fi%WB
%D4E%ID:3
%D4E%sentence:じゃ、<BLANK>はたいへんね。
%D4E%english:So weekdays are really tough for you.
%D4E%answer:へいじつ
%D4E%model:平日
%D4E%roman:heijitsu
%D4E%notes:taihen (hard).
  \ifWB
  \item ええ、\ruby{疲}{つか}れて、\ruby{帰}{かえ}って、\underline{\hspace{6em}}、ベッドに\ruby{入}{はい}って、..。\mySound{04804}\\Yeah, I get tired, go home, take a bath, get into bed, and...
  \else
  \item ええ、\ruby{疲}{つか}れて、\ruby{帰}{かえ}って、\underline{お\ruby{風呂入}{ふろはい}って}、ベッドに\ruby{入}{はい}って、..。\mySound{04804}\\Yeah, I get tired, go home, take a bath, get into bed, and...
  \fi%WB
%D4E%ID:4
%D4E%sentence:ええ、(疲:つか)れて、(帰:かえ)って、<BLANK>、(ベッド:べっど)に(入:はい)って、..。
%D4E%english:Yeah, I get tired, go home, take a bath, get into bed, and...
%D4E%answer:おふろはいって
%D4E%model:お風呂入って
%D4E%roman:ofurohaitte
%D4E%notes:tsukarete (got tired); kaette (went home); beddo (bed); haitte (entered).
  \ifWB
  \item \underline{\hspace{6em}}うちに、\ruby{毎晩}{まいばん}、\ruby{眠}{ねむ}っちゃってます。\mySound{04805}\\Before I know it, I fall asleep every night.
  \else
  \item \underline{\ruby{知}{し}らない}うちに、\ruby{毎晩}{まいばん}、\ruby{眠}{ねむ}っちゃってます。\mySound{04805}\\Before I know it, I fall asleep every night.
  \fi%WB
%D4E%ID:5
%D4E%sentence:<BLANK>うちに、(毎晩:まいばん)、(眠:ねむ)っちゃってます。
%D4E%english:Before I know it, I fall asleep every night.
%D4E%answer:しらない
%D4E%model:知らない
%D4E%roman:shiranai
%D4E%notes:uchini (while); maiban (every night); nemucchatte (slept).
  ...
  \ifWB
  \item \underline{\hspace{6em}}ごめん。 \mySound{04806}\\Sorry I'm late.
  \else
  \item \underline{\ruby{遅}{おく}れて}ごめん。 \mySound{04806}\\Sorry I'm late.
  \fi%WB
%D4E%ID:6
%D4E%sentence:<BLANK>ごめん。
%D4E%english:Sorry I'm late.
%D4E%answer:おくれて
%D4E%model:遅れて
%D4E%roman:okurete
...
%D4E%notes:
  \ifWB
  \item そんなの\underline{\hspace{6em}}！どうもありがとう。\mySound{04809}\\You didn't have to! Thank you so much.
  \else
  \item そんなの\underline{よかったのに}！どうもありがとう。\mySound{04809}\\You didn't have to! Thank you so much.
  \fi%WB
%D4E%ID:9
%D4E%sentence:そんなの<BLANK>！どうもありがとう。
%D4E%english:You didn't have to! Thank you so much.
%D4E%answer:よかったのに
%D4E%model:よかったのに
%D4E%roman:yokattanoni
%D4E%notes:sonnnano (such a thing); doumo arigatou (thank you).
  \ifWB
  \item そんな\underline{\hspace{6em}}よ。\mySound{04810}\\Oh, I couldn't not do it.
  \else
  \item そんな\underline{わけにはいかない}よ。\mySound{04810}\\Oh, I couldn't not do it.
  \fi%WB
%D4E%ID:10
%D4E%sentence:そんな<BLANK>よ。
%D4E%english:I couldn't not do it.
%D4E%answer:わけにはいかない
%D4E%model:わけにはいかない
...
\begin{enumerate}
  \ifWB
  \item \underline{\hspace{6em}}、\ruby{自然}{しぜん}と\ruby{成果}{せいか}は\ruby{出}{で}ますね。\mySound{04901}\\If you do things properly, the results will come naturally.
  \else
  \item \underline{ちゃんとすれば}、\ruby{自然}{しぜん}と\ruby{成果}{せいか}は\ruby{出}{で}ますね。\mySound{04901}\\If you do things properly, the results will come naturally.
  \fi%WB
%D4E%ID:1
%D4E%sentence:<BLANK>、(自然:しぜん)と(成果:せいか)は(出:で)ますね。
%D4E%english:If you do things properly, the results will come naturally.
%D4E%answer:ちゃんとすれば
%D4E%model:ちゃんとすれば
%D4E%roman:chantosureba
%D4E%notes:shizennto (naturally); seika (result); demasu (come out).
  \ifWB
  \item \ruby{遠慮}{えんりょ}なく\underline{\hspace{6em}}\ruby{関係}{かんけい}ってちょっとむずかしいですよね。\mySound{04902}\\It's kind of hard to have a relationship where you can speak your mind freely.
  \else
  \item \ruby{遠慮}{えんりょ}なく\underline{\ruby{言}{い}い\ruby{合}{あ}える}\ruby{関係}{かんけい}ってちょっとむずかしいですよね。\mySound{04902}\\It's kind of hard to have a relationship where you can speak your mind freely.
  \fi%WB
%D4E%ID:2
%D4E%sentence:(遠慮:えんりょ)なく<BLANK>(関係:かんけい)ってちょっとむずかしいですよね。
%D4E%english:It's kind of hard to have a relationship where you can speak your mind freely.
%D4E%answer:いいあえる
%D4E%model:言い合える
%D4E%roman:iiaeru
%D4E%notes:enryonaku (without hesitation); kankei (relationship); muzukashii (difficult).
  \ifWB
  \item \underline{\hspace{6em}}っていないですよ。\mySound{04903}\\Nobody's perfect. / There's no such thing as a person who never makes mistakes.
  \else
  \item \underline{\ruby{間違}{まちが}えない\ruby{人間}{にんげん}}っていないですよ。\mySound{04903}\\Nobody's perfect. / There's no such thing as a person who never makes mistakes.
  \fi%WB
%D4E%ID:3
%D4E%sentence:<BLANK>っていないですよ。
%D4E%english:Nobody's perfect. / There's no such thing as a person who never makes mistakes.
%D4E%answer:まちがえないにんげん
%D4E%model:間違えない人間
%D4E%roman:machigaenaininngenn
%D4E%notes:
  \ifWB
  \item \underline{\hspace{6em}}、\ruby{次}{つぎ}に\ruby{進}{すす}むってことですね。\mySound{04904}\\Don't dwell on it — just move on.
  \else
  \item \underline{くよくよしないで}、\ruby{次}{つぎ}に\ruby{進}{すす}むってことですね。\mySound{04904}\\Don't dwell on it — just move on.
  \fi%WB
%D4E%ID:4
%D4E%sentence:<BLANK>、(次:つぎ)に(進:すす)むってことですね。
%D4E%english:Don't dwell on it — just move on.
%D4E%answer:くよくよしないで
%D4E%model:くよくよしないで
%D4E%roman:kuyokuyoshinaide
%D4E%notes:tugi (next); susumu (move on).
  \ifWB
  \item \underline{\hspace{6em}}、\ruby{同}{おな}じ\ruby{間違}{まちが}いを\ruby{極力}{きょくりょく}\ruby{減}{へ}らすってことですかね。\mySound{04905}\\If anything, it's about trying to avoid repeating the same mistakes.
  \else
  \item \underline{あえて\ruby{言}{い}うなら}、\ruby{同}{おな}じ\ruby{間違}{まちが}いを\ruby{極力}{きょくりょく}\ruby{減}{へ}らすってことですかね。\mySound{04905}\\If anything, it's about trying to avoid repeating the same mistakes.
  \fi%WB
%D4E%ID:5
%D4E%sentence:<BLANK>、(同:おな)じ(間違:まちが)いを(極力:きょくりょく)(減:へ)らすってことですかね。
%D4E%english:If anything, it's about trying to avoid repeating the same mistakes.
%D4E%answer:あえていうなら
%D4E%model:あえていうなら
...
%D4E%notes:onaji (same); kyokuryoku (as much as possible); herasu (reduce).
  ...
  \ifWB
  \item そうなったら、\underline{\hspace{6em}}に\ruby{考}{かんが}えますよ。\mySound{04906}\\If that happens, I'll think about it then.
  \else
  \item そうなったら、\underline{そうなったとき}に\ruby{考}{かんが}えますよ。\mySound{04906}\\If that happens, I'll think about it then.
  \fi%WB
%D4E%ID:6
%D4E%sentence:そうなったら、<BLANK>に(考:かんが)えますよ。
%D4E%english:If that happens, I'll think about it then.
%D4E%answer:そうなったとき
%D4E%model:そうなったとき
...
%D4E%notes:kaifuugo (after opening it); meshiagaru (eat, honorific).
  \ifWB
  \item \underline{\hspace{6em}}、\ruby{棒}{ぼう}に\ruby{当}{あた}る。\mySound{04908}\\When dogs walk around, they might get hit by a stick.
  \else
  \item \underline{\ruby{犬}{いぬ}も\ruby{歩}{ある}けば}、\ruby{棒}{ぼう}に\ruby{当}{あた}る。\mySound{04908}\\When dogs walk around, they might get hit by a stick.
  \fi%WB
%D4E%ID:8
%D4E%sentence:<BLANK>、(棒:ぼう)に(当:あ)たる。
%D4E%english:When dogs walk around, they might get hit by a stick.
%D4E%answer:いぬもあるけば
%D4E%model:犬も歩けば
%D4E%roman:inumoarukeba
%D4E%notes:bou (stick); ataru (hit).
  \ifWB
  \item \ruby{猿}{さる}も\underline{\hspace{6em}}。\mySound{04909}\\Even experts make mistakes. / Even monkeys fall from trees.
  \else
  \item \ruby{猿}{さる}も\underline{\ruby{木}{き}から\ruby{落}{お}ちる}。\mySound{04909}\\Even experts make mistakes. / Even monkeys fall from trees.
  \fi%WB
%D4E%ID:9
%D4E%sentence:(猿:さる)も<BLANK>。
%D4E%english:Even experts make mistakes. / Even monkeys fall from trees.
%D4E%answer:きからおちる
%D4E%model:木から落ちる
%D4E%roman:kikaraochiru
%D4E%notes:saru (monkey).
  \ifWB
  \item \ruby{終}{お}わりよければ、\underline{\hspace{6em}}。\mySound{04910}\\If the ending is good, everything is good.
  \else
  \item \ruby{終}{お}わりよければ、\underline{\ruby{全}{すべ}てよし}。\mySound{04910}\\If the ending is good, everything is good.
  \fi%WB
%D4E%ID:10
%D4E%sentence:(終:お)わりよければ、<BLANK>。
%D4E%english:If the ending is good, everything is good.
%D4E%answer:すべてよし
%D4E%model:すべてよし
...
%    \put(38, 30){\fbox{\includegraphics[width=35mm]{./img/tokyotechlogo/symbol_pdf_ja_180704/シンボルマーク+ロゴタイプ和文英文左右.pdf}}}
    \put(38, 30){\fbox{\includegraphics[width=35mm]{./img/sciencetokyo.png}}}
    \put(38, 10){\includegraphics[trim=0 0 0 0, clip, width=38.5mm]{./img/KAKENHIlogo_M.eps}}
  \end{picture}
